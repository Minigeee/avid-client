...
export function errorWrapper<T extends (...args: any) => any>(fn: T, options?: AxiosErrorHandlerOptions) {
	// Error handler
...
export function swrErrorWrapper<T extends (...args: any) => Promise<any>>(fn: T, options?: AxiosErrorHandlerOptions) {
