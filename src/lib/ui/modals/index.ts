...
import CreateChannelGroup, {
  CreateChannelGroupProps,
} from './CreateChannelGroup';
...
import ChannelGroupSettings, {
  ChannelGroupSettingsProps,
} from './ChannelGroupSettings';
...
export const openCreateCalendarEvent = (props: CreateCalendarEventProps) =>
  openContextModal({
    modal: 'create-calendar-event',
    title:
      props.mode === 'edit'
        ? props.event?.title || 'Edit Calendar Event'
        : 'New Calendar Event',
    innerProps: props,
    size: 'lg',
    zIndex: 302,
...
export const openCreateChannelGroup = (props: CreateChannelGroupProps) =>
  openContextModal({
...
export const openCreateDomain = (props: CreateDomainProps) =>
  openContextModal({
    modal: 'create-domain',
...
export const openCreateTask = (props: CreateTaskProps) =>
  openContextModal({
    modal: 'create-task',
    title: `New ${
...
export const openEditTask = (props: EditTaskProps) =>
  openContextModal({
    key: props.task.id,
    modal: 'edit-task',
...
export const openCreateTaskCollection = (props: CreateTaskCollectionProps) =>
  openContextModal({
...
export const openEditTaskCollection = (props: EditTaskCollectionProps) =>
  openContextModal({
...
export const openDomainSettings = (props: DomainSettingsProps) =>
  openContextModal({
...
/** Open domain settings modal */
export const openChannelSettings = (props: ChannelSettingsProps) =>
  openContextModal({
...
/** Open domain settings modal */
export const openChannelGroupSettings = (props: ChannelGroupSettingsProps) =>
  openContextModal({
...
export const openUserSettings = (props: UserSettingsProps) =>
  openContextModal({
    modal: 'user-settings',
    withCloseButton: false,
    innerProps: props,
...
/** Opens the modal to create channel groups */
export const openAttachmentPreview = (props: AttachmentPreviewProps) =>
  openContextModal({
