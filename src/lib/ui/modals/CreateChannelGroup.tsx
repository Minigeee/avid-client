...
////////////////////////////////////////////////////////////
export default function CreateChannelGroup({ context, id, innerProps: props }: ContextModalProps<CreateChannelGroupProps>) {
  const form = useForm({
    initialValues: {
      name: '',
      allow_everyone: true,
  ...
  return (
    <form onSubmit={form.onSubmit(async (values) => {
      try {
        ...
        // Add group
        await props.domain._mutators.addGroup(values.name, values.allow_everyone);
      ...
      <Stack>
        ...
        <Flex wrap='nowrap' gap='1.0rem' mt={8}>
          ...
          <Switch {...form.getInputProps('allow_everyone', { type: 'checkbox' })} />
        </Flex>
