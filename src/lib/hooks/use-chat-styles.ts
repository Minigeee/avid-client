...
const DEFAULT_THEMES = {
  ...
  } as Record<string, (theme: MantineTheme) => string>,
  dark: {
    md_code: (theme) => theme.colors.primary[1],
    md_code_text: (theme) => theme.colors.gray[8],
    md_table_header: (theme) => theme.colors.primary[1],
...
export const useChatStyles = (options?: {
  ...
  return createStyles((theme) => {
    const colors = theme.other?.elements || DEFAULT_THEMES[theme.colorScheme];
    ...
    return {
      typography: {
        ...
        blockquote: {
          ...
          borderLeft: `4px solid ${colors.md_table_border}`,
